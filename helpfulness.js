function load(){
    ...
    button1.addEventListener("click",function(){
        ...
        if (flipped == true){resultstring = resultstring + examples[3].substring(0, 1) + "c";}
        else{resultstring = resultstring + examples[3].substring(0, 1) + "h";}
        loadexample();
    });
    ...
    button2.addEventListener("click",function(){
        ...
        if(flipped == true){resultstring = resultstring + examples[3].substring(0, 1) + "h";}
        else{resultstring = resultstring + examples[3].substring(0, 1) + "c";}
        loadexample();
    });
